...
function draw_empty_board(p) {
	...
	$('#tavli_board').html(t);
	$('.tavli_square').click(click_on_piece);
}
...
function game_status_update() {
	...
	clearTimeout(timer);
	$.ajax({url: "tavli.php/status/", success: update_status,headers: {"X-Token": me.token} });
}
...
function update_moves_selector() {
	$('.tavli_square').removeClass('pmove').removeClass('tomove');
